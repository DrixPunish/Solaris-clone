...
/**
  ...
  const probeCount = activePlanet.ships.spectreSonde ?? 0;

  if (probeCount === 0) {
    showGameAlert(
      'Pas de sondes',
      'Construisez des Spectre Sondes dans le chantier spatial.'
    );
    return;
  }
  ...
  router.push({
    ...
    params: {
      ...
      targetPlanet: player.planetname,
      defaultMission: 'espionage',
    },
  });
}, [activePlanet.ships, viewGalaxy, viewSystem, router]);
